...
Route::prefix('facultad')->group(function () {
    ...
    Route::post('/update', [FacultadController::class, 'update']);
...
Route::prefix('ciclo')->group(function () {
    ...
    Route::post('/update', [CicloController::class, 'update']);
...
Route::prefix('programa')->group(function () {
    ...
    Route::post('/update', [ProgramaAcademicoController::class, 'update']);
...
Route::prefix('condicion')->group(function () {
    ...
    Route::post('/update', [CondicionController::class, 'update']);
...
Route::prefix('capitulo')->group(function () {
    ...
    Route::post('/update', [CapituloController::class, 'update']);
...
Route::prefix('asignatura')->group(function () {
    ...
    Route::post('/update', [AsignaturaController::class, 'update']);
